...
\[
  \begin{array}{lcl}
    \tmcol\tvar & : & (\Gamma.P.\Delta)_{s(\vec 0.1.\vec 0)}
       \to \Gamma_{\vec 0} \otimes P_s \otimes \Delta_{\vec 0}
       \to P_s \\
    \tmcol\tlet & : & \Gamma_{\gamma + r\delta}
...
\[
  \begin{array}{lcl}
    \tmcol\tthunk & : & \Gamma_{r\gamma} \to \Box_r\Gamma_\gamma \to \Box_rN = (\Box N)_r \\
    \tmforce & : & \Gamma_\gamma = \Gamma_{1\gamma} \to (\Box N)_1 = \Box_1 N \to N \\
  \end{array}
\]
  \end{itemize}
\end{frame}
...
\[
  \begin{array}{lcl}
    \tmret & : & \Gamma_{r\gamma} \to P_r \to \diamond P_r = \langle r \rangle P \\
    \tmbind & : & \Gamma_{\gamma + \delta}
...
\begin{frame}%[fragile=singleslide]
  ...
  \item Interpreted as $\Gamma_{r\gamma} \to P_r$ and $\Gamma_\gamma \to N_{\e}$.
  \item Monad $(\langle r \rangle P)_{\e} = \diamond_{\e} P_r$ and comonad $([\e]N)_r = \Box_r N_{\e}$.
