...
% \[
% \begin{array}[t]{lcl}
%   \upG P  & : & \Var P \Gamma \to \Cov\,\den P \, \Gamma\\
%   \downG P & : & \den P \Gamma \to \VNf P \Gamma \\
% \end{array}
% \qquad
% \begin{array}[t]{l@{\,}l@{~~}c@{~~}l}
%   \multicolumn 2 l {\upG N} & : & \Ne N \Gamma \to \den N \Gamma \\
%   \multicolumn 2 l {\downG N} & : & \den N \Gamma \to \Nf N \Gamma \\
% \end{array}
% \]

% Positive \fbox{$\VNf P \Gamma$} and negative \fbox{$\Nf N \Gamma$}
% normal forms.
% \begin{small}
% \begin{gather*}
%   \nru{\tvar}{\Var \patom \Gamma}{\PValNf {\patom} \Gamma}
...
% Neutral normal forms \fbox{$\Ne N \Gamma$}
% and the strong monad \fbox{$\Cov$}.
% \begin{small}
% \begin{gather*}
%   \nru{\tforce}{\VarP {\Thunk N} \Gamma}{\Ne N \Gamma}
% \qquad
