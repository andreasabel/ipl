...
\date[OSem Jun 2019] % (optional, should be abbreviation of conference name)
...
\\
\\
&& \hyp\tyAi{\cover{\den{\tyAi}}}   \ar[uu]\LESS{_{\hyp\tyAi{\cover{\inject1}}}}
&& \hyp\tyAii{\cover{\den{\tyAii}}} \ar[uu]\LESS{_{\hyp\tyAii{\cover{\inject2}}}}
\\
\\
&& \hyp\tyAi{\Var{\tyAi}}   \ar[uu]_{\hyp\tyAi{\reflect{\tyAi}}}
&& \hyp\tyAii{\Var{\tyAii}} \ar[uu]_{\hyp\tyAii{\reflect{\tyAii}}}
...
\item
\textbf{Catarina Coquand}:
From Semantics to Rules: A Machine Assisted Analysis.
CSL 1993.

\item
\textbf{Achim Jung, Jerzy Tiuryn}:
A New Characterization of Lambda Definability. TLCA 1993.

\item
\textbf{Thorsten Altenkirch, Martin Hofmann, Thomas Streicher}:
...
\item
\textbf{T. Altenkirch, P. Dybjer, M. Hofmann, Ph. Scott}:
...
\item
\textbf{Freiric Barral}:
Decidability for non-standard conversions in $\lambda$-calculus. \\
PhD thesis, LMU Munich, 2008.

\item
\textbf{Gabriel Scherer}:
Deciding equivalence with sums and the empty type.
POPL 2017.
\item
\textbf{G. Allais, R. Atkey, J. Chapman, C. McBride, J. McKinna}: \\
