...
the $\tbind$ind of a neutral of type $\Comp P$ to a new variable of type
...
Reification $\down P : \den P \todot \tVal[\tNf]\,P$ at positive types produces
...
introduce positive types ($\tVal$).  However, the elimination of
