...
$\dent{ v : \PValTm P \Gamma } : \den \Gamma \todot \den P$
and terms
$\dent{ t : \Tm N \Gamma } : \den \Gamma \todot \den N$
is straightforward, thanks to the pioneering work of
Moggi \cite{moggi:infcomp91} and
Levy \cite{levy:hosc05}
...
\fbox{$\tfresh^P_\Gamma = \up[\cext \Gamma P] P \vv0 : \Cov\,\den P$}.
\[
