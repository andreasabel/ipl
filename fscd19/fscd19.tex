...
\treindex\,(\tau_1 \comp \tau_2)\,x$} hold propositionally.
...
with respect to a equational theory $\cong$ on terms.  Defining
...
%\footnote{
A more accurate presentation of $\tNF$ would have been
$\sum_{u : \tNf A\,\Gamma} (\tm u \cong t)$ to make absolutely clear that we
want get hold of the witness $u$ of the existential statement;
however, we shall only use constructive
existentials\footnote{Constructive existence in
