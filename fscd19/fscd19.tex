...
\end{array}
\]
We shall immediatly construct an instance of such a cover monad,
...
The typings are $c : \C \den{A \To B} \Gamma$, $\tau : \Gamma \sublist
\Delta$, $a : \den A \Delta$, and now we want to apply every function
