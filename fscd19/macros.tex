...
\newcommand{\Thunk}[1]{\mathit{Thunk}\,#1}
\newcommand{\Comp}[1]{\mathit{Comp}\,#1}
...
\newcommand{\PValT}[3][]{\Val^{\T}#2\,#3}
\newcommand{\PValTP}[3][]{\Val^{\T}(#2)\,#3}
...
\newcommand{\reflect}[3][]{\treflect_{#1}^{#2}\,#3}
\newcommand{\norm}[3][]{\tnorm_{#1}^{#2}\,#3}
